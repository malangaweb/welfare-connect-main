# Graph Report - Malanga Welfare  (2026-05-23)

## Corpus Check
- 300 files · ~577,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1200 nodes · 1474 edges · 47 communities detected
...
Cohesion: 0.02
Nodes (155): admin_shell.dart, ../auth/auth_controller.dart, ../../core/auth/role_access.dart, ../../core/services/live_data_service.dart, main, AppColors, AdminAccountsScreen, _AdminAccountsScreenState (+147 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (85): fetchMembers(), handleTransfer(), handleTransferClick(), handleSubmit(), addToRemoveQueue(), dispatch(), genId(), reducer() (+77 more)
...
- **Thin community `Community 23`** (10 nodes): `MpesaClient`, `.checkTransactionStatus()`, `.constructor()`, `.generatePassword()`, `.getAccessToken()`, `.getBaseUrl()`, `.getTimestamp()`, `.initiateStkPush()`, `.sendB2C()`, `client.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (8 nodes): `buildMissingReceiptKey()`, `normalizeMpesaReference()`, `normalizePhoneNumber()`, `parseMpesaTimestamp()`, `sanitizeReferencePart()`, `parseBillReference()`, `index.ts`, `reference-parser.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (6 nodes): `isInvalidUuidError()`, `jsonResponse()`, `normalizeCandidate()`, `resolveMember()`, `verifyToken()`, `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (6 nodes): `isInvalidUuidError()`, `jsonResponse()`, `normalizeCandidate()`, `resolveMemberId()`, `verifyToken()`, `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (6 nodes): `fetchTransactions()`, `handleEdit()`, `handleRevert()`, `handleSave()`, `handleSearchChange()`, `Transactions.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (5 nodes): `findMemberByNumber()`, `jsonResponse()`, `memberNumberCandidates()`, `normalizePhone()`, `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (5 nodes): `RunnerTests.swift`, `RunnerTests.swift`, `RunnerTests`, `.testExample()`, `XCTestCase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (4 nodes): `handle_new_rx_page()`, `__lldb_init_module()`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `flutter_lldb_helper.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `package:flutter/material.dart` connect `Community 0` to `Community 3`, `Community 5`, `Community 7`, `Community 11`, `Community 13`, `Community 31`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `toast()` connect `Community 1` to `Community 33`, `Community 4`, `Community 9`, `Community 17`, `Community 19`, `Community 25`?**
