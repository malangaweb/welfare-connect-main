  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      try {
        ...
        const normalizedRole = normalizeRole(user?.role as string | undefined);
        
        const authorized = !!normalizedRole && resolvedAllowedRoles.includes(normalizedRole);
        ...
        if (!authorized) {
          await logAuthorizationFailure(
            ...
            `User role '${normalizedRole}' not in allowed roles: ${resolvedAllowedRoles.join(', ')}`
          );
        }
